...
(function (B, A) {
  ...
  let A,
          ...
          for (; --i > -1; ) {
            ...
            for (n of s)
              if (n.startsWith(c) && n.length > c.length) {
                for (
                  o = 0, a = c;
                  n.startsWith((a += e[i + ++o])) && a.length < n.length;
    ...
    z = (e, t, s) =>
      t.insertBefore(typeof e == 'string' ? document.createTextNode(e) : e, s),
    Q = (e, t, s) => {
      let i = t[e + 'sClass'] || '',
        ...
        b = (x) => {
          ...
          return (
            ...
            o !== 'span' &&
              ((g.style.position = 'relative'), (g.style.display = a)),
            (g.textContent = x),
            s.push(g),
            g
          );
    ...
    ie = (e, t, s, i, o, c, n, a, h, b) => {
      ...
      let g = Array.from(e.childNodes),
        ...
        j = q,
        D =
          !L && window.getComputedStyle(e).whiteSpace.substring(0, 3) === 'pre',
        E = 0,
        v = s.collection,
        r,
        f,
      ...
      for (
        typeof R == 'object'
          ? ((H = R.delimiter || R), (f = R.replaceWith || ''))
          : (f = R === '' ? '' : R || ' '),
          r = f !== ' ';
        C < g.length;
        C++
...
` &&
              ...
              if (
                ...
                E && u === 1 && !I && v.indexOf(E.parentNode) > -1
                  ? ((y = v[v.length - 1]),
                    y.appendChild(document.createTextNode(i ? '' : p)))
                  : ((y = s(i ? '' : p)),
                    z(y, e, l),
                ...
                for (
                  ...
                  y.appendChild(
                    S[N] === ' ' ? document.createTextNode(' ') : i(S[N])
                  );
              if (c && b) {
                if (
          ...
          l.nodeType === 1 &&
            (n && n.indexOf(l) > -1
              ? (v.indexOf(l.previousSibling) > -1 &&
                  v[v.length - 1].appendChild(l),
                (E = l))
  ...
  const ne = class se {
    ...
    split(t) {
      ...
      let {
        ...
        R = g && !C && !x,
        L =
          h && ('push' in h ? new RegExp('(?:' + h.join('|') + ')', 'gu') : h),
      ...
      return (
          ...
          (this.elements.forEach((r, f) => {
            ...
            if ((ie(r, t, I, y, R, o && (x || R), q, $, L, !1), x)) {
              let O = P(r.childNodes),
                ...
                p = 0,
                k = O.map((M) =>
                  M.nodeType === 1 ? M.getBoundingClientRect() : Z
                ),
                N = Z;
            ...
            this.masks.push(
              ...this[b].map((r) => {
                ...
                return (
                  ...
                  f.appendChild(r),
                  r.className &&
                    (f.className = r.className.replace(
                      /(\b\w+\b)/g,
                      '$1-mask'
                    )),
        ...
        (v = n && n(this)) &&
          v.totalTime &&
          (this._data.anim = D ? v.totalTime(D) : v),
        x &&
          a &&
          this.elements.forEach((r, f) => {
    ...
    revert() {
      ...
      return (
        ...
        i.forEach(({ element: n, html: a, ariaL: h, ariaH: b }) => {
          (n.innerHTML = a),
            h
              ? n.setAttribute('aria-label', h)
              : n.removeAttribute('aria-label'),
            b
              ? n.setAttribute('aria-hidden', b)
