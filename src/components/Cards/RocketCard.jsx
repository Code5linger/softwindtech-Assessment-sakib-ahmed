const RocketCard = () => {
  return (
    <div className="group flex flex-shrink-0 items-center justify-center px-6  py-6 bg-[#4D4D4F17] rounded-2xl hover:bg-[#4D4D4F] transition-colors duration-300 ">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 38 38"
        className="min-h-10 flex-shrink-0 w-10 fill-current text-[#414042] group-hover:text-[#FF4306] transition-all duration-300 group-hover:scale-110 group-hover:rotate-3 group-hover:drop-shadow-lg  ml-8 sm:ml-7 lg:ml-0"
      >
